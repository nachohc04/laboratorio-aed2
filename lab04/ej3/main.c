...
/*
 a) Luego de ejecutar 5 veces este algoritmo y el del lab03 al mismo tiempo y con el mismo archivo input, conclui que este algoritmo es notablemente mas rapido, obteniendo una media de ejecucion de 0,0016466ms en el algoritmo del lab03 y una media de 0,000773ms para esta implementacion con punteros.
 b) Es mas rapido con punteros porque cuando no se usan C hace copias de las variables y lee y modifica dichas copias, en cambio con punteros se lee y modifica directamente la variable cuya direccion fue especificada.
*/